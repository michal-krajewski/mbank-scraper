...
import static pl.byteit.mbankscraper.operation.mbank.account.AccountInfoTestFactory.standardAccountInfo;
...
class MbankClientTest {
	...
	void beforeEachMbankOperationManagerTest() {
		...
		operationManager = new MbankClient(mockClient, cli, secondFactorAuthenticationManager);
	}
