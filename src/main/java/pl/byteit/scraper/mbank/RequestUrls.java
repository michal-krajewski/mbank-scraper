...
public class RequestUrls {
	...
	public static final String FETCH_STANDARD_ACCOUNTS_URL = MBANK_BASE_URL + "/pl/MyDesktop/Dashboard/GetProducts";
	public static final String LOGIN_URL = MBANK_BASE_URL + "/pl/LoginMain/Account/JsonLogin";
	public static final String FETCH_REQUEST_VERIFICATION_TOKEN_URL = MBANK_BASE_URL + "/pl/setup/data";
	public static final String FETCH_SAVING_ACCOUNTS_URL = MBANK_BASE_URL + "/pl/SavingGoals/Home/GetSavingProducts";
