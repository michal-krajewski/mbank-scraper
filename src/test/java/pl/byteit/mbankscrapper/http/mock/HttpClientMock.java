...
import pl.byteit.mbankscrapper.http.mock.RequestBuilderMock.MockRequestBuilderAssert;
...
public class HttpClientMock implements HttpClient {
	...
	private Map<String, List<RequestBuilderMock>> savedRequests;
	private Map<String, String> mockedResponses;
